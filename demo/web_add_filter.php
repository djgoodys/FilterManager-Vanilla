...
<tr><td></td><td><b>Add New Filter Size</b></td><tr>
            ...
            <tr><td class="<?php echo $TDstyle ?>">Create Filter size</td><td class="<?php echo $TDstyle ?>">width&nbsp;&nbsp;<input type='text' onkeyup='setfilters();' maxlength='2' style='font-weight: bold; overflow: hidden; max-width: 3ch;' id='fsize1' name='fsize1' value=''>&nbsp;height&nbsp;&nbsp;<input type='text' onkeyup='setfilters();' maxlength='2' style='font-weight: bold; overflow: hidden; max-width: 3ch;' id='fsize2' name='filter_size2' value=''>&nbsp;depth&nbsp;&nbsp;<input type='text' onkeyup='setfilters();' maxlength='2' style='font-weight: bold; overflow: hidden; max-width: 3ch;' id='fsize3' name='fsize3' value=''>
            <font size="2" color="red"><em>Input smaller dimension first i.e. 20X24X1 not 24X20X1</em></td></tr>
         
        <tr><td class="<?php echo $TDstyle ?>">This Filter Size</td><td class="<?php echo $TDstyle ?>"><input type='text' class="form-control" style='font-weight: bold; width: 300px;' id='filter_size' name='filter_size' value=''  readonly></td></tr>
</td></tr>
...
<tr><td>Par</td><td> <input type="text" class="form-control" style='font-weight: bold; width: 300px;' name="par"></td></tr>
<tr><td>Notes</td><td><textarea class="form-control" rows="4" cols="20" style='font-weight: bold; width: 300px;' maxlength ="50" name="notes"></textarea></td></tr>
<tr><td></td><td><input type="submit" class="btn-success"><input type="hidden" name="action" value="addfilter"></form></td></tr>
    </table>
