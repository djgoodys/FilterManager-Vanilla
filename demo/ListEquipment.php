...
<body style="<?php echo $TDstyle ?>"  onload="getusername();">
<script>
...
//GET LAST SEARCH WORD AND FILL SEARCHBOX
var lastsearch=readCookie("search");
if(lastsearch != ""){
document.getElementById("myInput").value = lastsearch;
myFunction();
document.getElementById("clearsearch").style.display="block";
}
document.cookie = "lastpage=ListEquipment.php";
txtUsername=document.getElementById("divUserName");
  ...
  for (var i=0; i<pairs.length; i++)
      {
         ...
         if(pairs[i].search("user") > -1)
            {
               var h = pairs[i].split("=");
               var UserName=document.getElementById("divUserName").innerHTML=h[1];
               document.getElementById("divUserName").innerHTML=h[1];
            }
         if(UserName="")
         {
...
if ($Action == "addtask") {
    ...
    if(isset($_POST['filters_due'])){$FiltersDue = ($_POST['filters_due']);}
   // echo "id=".$UnitID ." unit name=".$UnitName." filtersize=".$FilterSize."rotation=".$FilterRotation ." fdue=".$FiltersDue;
...
?>
   ...
   <font color='black'>
     <table><tr><th style="display:inline-block;color:black;"><th>
     <img class="super-centered" style="display:none;" src="clearsearch.png" id="clearsearch" onclick="clearsearch();"><input type="text" style="height:40px;width:150px;font-size:1em;" id="myInput" onclick="document.getElementById('clearsearch').style.display='block';" placeholder='Search' >
     <img src="search.png" height="30px" width="30px" align="middle" onclick="myFunction();"> </th>
     <th></th><th><font size="3">
         <form action="ListEquipment.php" method="POST" id="cklate"><font color="red">OVERDUE</font><br>
         <input type="hidden" name="username" value="<?php echo $UserName ?>">
         <input type="checkbox" class="checkmark" id="ckoverdue" name="ckoverdue" onChange="this.form.submit();"<?php echo $ShowOverDue ?>>

         </form></th><th><form action="ListEquipment.php" method="POST" id="cklate">
         <SELECT id="bydate" name="bydate" onchange="this.form.submit()" style="font-size:20px;">
         ...
         <th><a href="print.php"><img src="print.jfif" height="40px" width="40px" align="middle"></a></th><th><img src="settings.jfif" height="35px" width="35px" onclick="showsettings();"></th><th id="tdSettings" style="visibility:hidden;">
		     <form action='ListEquipment.php' method='POST'>
             
<SELECT id='selFontSize' class="myoption" onchange='this.form.submit();' name='fontsize'>
<option class="myoption" value="10"
<?php 
if(strcmp($FontSize, "10")==0){echo " selected";} 
?>
>Font size 10</option>
<option class="myoption" value ='20' 
<?php 
if(strcmp($FontSize, "20")==0){echo " selected";} 
?>
>Font size 20</option>
<option class="myoption" value ='30' 
<?php 
if(strcmp($FontSize,"30")==0){echo " selected";} 
?>
>Font size 40</option>
<option class="myoption" value='40' 
<?php 
if(strcmp($FontSize, "40")==0){echo " selected";} 
?>
>Font size 60</option>
<option class="myoption" value='60' 
<?php 
if(strcmp($FontSize, "60")==0){echo " selected";} 
?></option>
</SELECT></optgroup>

<select id='selTheme' class="myoption" name='theme' onchange='this.form.submit();'>
<option class="myoption" value='select_theme'>Theme</option><option class="myoption" class="myoption" value='Dark-tdPlain'>Dark</option>
<option class="myoption" value='Light-tdPlain'>Light</option></select><br><A Href="backuptocsv.php"><p style="background-color:green;color white;"> BACK UP DATA</p></A>

</th>
		 <th width="250px" height="50px"><div style="background-color:orange;font-size:<?php echo $FontSize ?>;color:black;">Out Of Stock</div>    
       <div style="background-color:red;font-size:<?php echo $FontSize ?>;color:white;">Filters Over Due</div></th><td><a href="webAddUnit.php"><div style="background-color:green;height:50px;width:100;font-weight:bold;font-size:16px;color:white;padding:5px;">ADD NEW<br>&nbsp;&nbsp;&nbsp;UNIT</div></a></td>
       <td><div style="font-color:black; color:white;" id="divUserName"><?php echo "User:". $UserName ?></div></td>
...
<tr><td class="<?php echo $TDstyle ?>"></td><td class="<?php echo $TDstyle ?>"></td>
    <tr class="myTable">
        <th style="background-color:#07ff10"><font color="black">
		...
		<form action="ListEquipment.php" method="post">
        <th style="background-color:#07ff10"><font color="black" id="thfield2">
        <select name="field2" id="selField2" onchange="this.form.submit();" class="myselect"> 
        <option class="myoption" value="area_served"
        <?php
        if(strcmp($Field2, "area_served")==0){ echo " SELECTED";}
        ?>
        >Area Served</option>
        <option class="myoption" value="location"
        <?php
        if(strcmp($Field2, "location")==0){ echo " SELECTED";}
        ?>
        >Location</option>
        <option class="myoption" value="bylastchanged"
        <?php
        if(strcmp($Field2, "bylastchanged")==0){ echo " SELECTED";}
        ?>
        >By last changed</option>
        <option class="myoption" value="select_one">Select filter
        </option></select>
		</th>
        <th style="background-color:#07ff10"><font color="black" id="thfield3">
        <font size="<?php echo $FontSize ?>"><select name="field3" onchange="this.form.submit();" class="myselect">
        <option class="myoption" value="area_served2"
        <?php
        if(strcmp($Field3, "area_served2")==0){ echo " SELECTED";}
        ?>
        >Area Served</option>
        <option class="myoption" value="location2"
        <?php
        if(strcmp($Field3, "location2")==0){ echo " SELECTED";}
        ?>
        >Location</option>
        <option class="myoption" value="filtersize"
        <?php 
        if(strcmp($Field3, "filtersize")==0){ echo " SELECTED";}
        ?>
        >Filter size</option>
        <option class="myoption" value="notes"
        <?php
        if(strcmp($Field3, "notes")==0){ echo " SELECTED";}
        ?>
        >Notes</option>
        <option class="myoption" value="select_one2">Select filter
        </option></select></th></form>
        </font></th>
        <th style="background-color:#07ff10"><font color="black">Due Date</font></th>
        
    </tr>
   <form action="ListEquipment.php" method="post" id="frmsubmittasks">
       ...
       // $daysoverdue=  $diff = date_diff("d",$today, $someDate);
        ...
        //echo "<br>TDstyle=".$TDstyle."fontcolor=".$FontColor;
			...
			?>
                ...
                if(strcmp($Field2, "bylastchanged")==0)
                  {
				  $setField2 = "filters last changed";
                  echo "<td style='".$myCss."'>". $FiltersLastChanged ."</td>";
                  }
                  
                if(strcmp($Field3, "location2")==0)
                  {
					$setField3 = "location";
                     echo "<td style='".$myCss."'>". $location."</td>";
                  }
                if(strcmp($Field3, "area_served2")==0)
                  {
					$setField3 = "area served";
                     echo "<td style='".$myCss."'>". $AreaServed ."</td>";
                  }
                  if(strcmp($Field3, "bylastchanged2")==0)
                  {
				  $setField3 = "filters last changed";
                  echo "<td style='".$myCss."'>". $FiltersLastChanged ."</td>";
                  }
                  if(strcmp($Field3, "notes")==0)
                  {
				  $setField3 = "notes";
                  echo "<td style='".$myCss."'>". $notes."</td>";
                  }
                  if(strcmp($Field3, "filtersize")==0)
                  {
                        
				        $setField3 = "filter size";
						...
						//echo "myCss=".$myCss." theme=".$Theme." days=".$daysoverdue." size=".$FilterSize." oos=".$outofstock." Alink font color:".$AlinkCss."<br>";
                        echo "<td style='".$myCss."'><a href='web_update_filters.php/#".$FilterSize ."' style='color:".$AlCss.";'>". $FilterSize . "</a></td>";                     
                    }
