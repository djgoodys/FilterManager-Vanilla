...
?>
<tr><td class="<?php echo $TDstyle ?>"><form action='mListEquipment.php' method='post'> 
<input type="submit" value="UNIT LIST" style="font-size : 20px; width: 200px; height:70px;color:gold; background-color:green;" id='btnGoToUnitlist' name='btnGoUnitList'>
...
<?php
    ...
    ?>
        <tr><td class="<?php echo $TDstyle ?>"><form action='mListEquipment.php' method='post'> 
        <input type="submit" value="UNIT LIST"  
        style="font-size : 20px; width: 200px; height:70px;color:gold; background-color:green;" id='btnGoToUnitlist' name='btnGoUnitList'>
            ...
            <input type="hidden" name="username" value="<?php echo $UserName ?>"><input type='submit' style="background-color:green;color:gold;font-size : 20px; width: 200px; height:70px;" value='TASK HISTORY'></form>
            <form action = "PrintTasks.php" method="POST"><input type='submit' style="background-color:green;color:gold;font-size : 20px; width: 200px; height:70px;" value='PRINT...'>
