...
<body onload="DoOnLoadStuff();setScrollPosition();" onunload="saveScrollPosition();"  style="width:100vw;">
			...
			?>
                 ...
                 <table style="display:none;" id="tblUnitinfo<?php echo $unitId ?>">
                  ...
                  <tr id="trinfo"><td class="tdUnitInfo">Belts</td><td class="tdUnitInfo2"> <?php echo $belts ?></td></tr>
                   ...
                   <a href="../webEditUnit.php?_id=<?php echo $unitId ?>&username=<?php echo $UserName ?>" class="success" style="background-color:white;color:green;width:100%;height:170px;font-size:30px;font-weight: bold;">EDIT UNIT</a></font>
                   <!--<br>FILTERS DONE<BR>
                       <label class="switch">
                        <input type="checkbox" id="ckShowFilterTypes<?php echo $unitId ?>" onChange="showFilterTypes('<?php echo $unitId ?>');">
