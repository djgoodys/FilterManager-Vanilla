...
<body>
    ...
    <header class="d-flex justify-content-left py-3">
      <ul class="nav nav-pills">
        <li class="nav-item"><a href="mManageFilterTypes.php?Action=addfiltertype" class="nav-link"><button type="button" class="btn btn-success">Manage filter types</button></a></li>
        <li class="nav-item"><a href="mweb_update_filters.php" class="nav-link"><button type="button" class="btn btn-success">Back to filters</button></a></li>
      </ul>
    </header>
  </div>
<?php
...
<tr><td><h1>Add New Filter Size</h1></td><tr>
            <td><form method="POST" name="frmAddFilter" action="mweb_add_filter.php"></td>
...
<tr><td><h2>Filter Type</h2></td></tr><tr><td>
        <select class="form-select" aria-label="Default select example" name="filter_type">
            ...
            ?>
            </select>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn-success" href="mManageFilterTypes.php"><button type="button" class="btn btn-success .text-white">Manage filter types</butten></a>
      </ul>
    </div>
  </div>
