...
{
    $sql="UPDATE filter_types SET type ='". $Type."', trackable = '".$Trackable."' WHERE _id = $RowID;";
...
<form method="POST" name="frmFilterTypesaddnew" action="<?php echo $_SERVER['SCRIPT_NAME'] ?>">
    <input type="hidden" name="Action" value="insertfiltertype">
...
if($Action == "insertfiltertype"){
$sql = "INSERT INTO filter_types(type, trackable) VALUES ('".$Type."','". $Trackable."');";
if ($con->query($sql) === TRUE) {
