...
function openNav() {
parent.document.getElementsByTagName( 'frameset' )[ 0 ].rows='710,*';
...
<script>
        function doesElemExist(txtsize)
         {
...
<script>
    function addAmount()
    {
        ...
        var FiltersCounted = document.getElementById("divFiltersCounted").children;
         if(FiltersCounted.length==0)
            {
                var x = document.createElement("INPUT");
                x.setAttribute("type", "text");
                x.setAttribute("id", "size0");
                x.setAttribute("name", "fsize");
                x.setAttribute("title", AllFilters[0].getAttribute("data-size"));
                x.setAttribute("style", "width:300px");
                x.setAttribute("value", "(" + AllFilters[0].getAttribute("data-amount") + ") " + AllFilters[0].getAttribute("data-size") + " " + AllFilters[0].getAttribute("data-ftype"));
                x.setAttribute("data-ftype", AllFilters[0].getAttribute("data-ftype"));
                x.setAttribute("data-size", AllFilters[0].getAttribute("data-size"));
                x.setAttribute("data-amount", AllFilters[0].getAttribute("data-amount"));
                            ...
                            {  
                             elementedAdded = false;
                                for (let f = 0; f < FiltersCounted.length; f++) 
                                {
                                    ...
                                    if(AllFilters[p].name=="fsize" && AllFilters[p].getAttribute("data-size") == FiltersCounted[f].getAttribute("data-size") && AllFilters[p].getAttribute("data-ftype") == FiltersCounted[f].getAttribute("data-ftype"))
                                      {
    ...
    if(elemAllSizes.length == 0)  
                {
                    ...
                    document.getElementById("divFiltersNeeded").innerHTML="  for all tasks:";
...
<script>
function addTaskToForm(id, unitname, fromCookie) {
...
<script>
function expireJavaCookie(name) {
...
document.write("from function setJavaCookie name="+name+ " value="+value+"<br>");
document.write("using getJavaCookie "+name+"="+getJavaCookie(name)+"<br>");
}
</script>
...
function checkForm(formID){
        ...
        if(document.getElementById("unit_name").value == "")
            {
                formpass = false;
                elementx = document.getElementById("unit_name");
                errorcode = "Unit name can not be blank";
            }
